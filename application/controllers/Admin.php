...
class Admin extends CI_Controller {
    ...
    public function dashboard(){
        ...
        $data['count'] = $this->User_model->get_user_counts_by_roles();
    ...
    public function dfo_edit_profile($user_id){
        ...
        $data['division'] = $this->User_model->get_division();
        $this->load->view('admin/header', $data);
        $this->load->view('admin/dfo-edit', $data);
        $this->load->view('admin/footer');
    }

    public function dfo_list(){
        
        $dfo['dfo'] = $this->User_model->get_active_users("dfo");
        $this->load->view('admin/header', $data);
        $this->load->view('admin/dfo_list', $dfo);
        $this->load->view('admin/footer');
    }

    // Controller method for displaying the specific user profile
    public function dfo_profile($user_id) {
        // Fetch the user's data from the model based on user ID
        $dfo['dfo_user'] = $this->User_model->get_user_by_id($user_id);
        
        // Check if user data exists
        if (empty($dfo['dfo_user'])) {
            show_404();  // Show 404 if the user is not found
        }
        
        $dfo['teachers'] = $this->User_model->get_users_by_role_and_parent('teacher', $user_id);
        $dfo['blood_groups'] = get_blood_groups();
        // Pass user data to the view
        $this->load->view('admin/header',$data);
        $this->load->view('admin/dfo_profile', $dfo);  // Pass user data to the view
        $this->load->view('admin/footer');
    }

    public function save_dfo() {
    ...
    public function edit_dfo($user_id) {
        // Load necessary libraries and helpers
        $this->load->library('upload');
        $this->load->model('User_model');  // Make sure to load the model
...
////////////////////////////
    ...
    public function teacher_list(){
        ...
        $teacher['teacher'] = $this->User_model->get_active_users("teacher");
        $this->load->view('admin/header', $data);
        $this->load->view('admin/teacher_list', $teacher);
        $this->load->view('admin/footer');
    }
    ...
    public function teacher_profile($user_id) {
        ...
        // Pass user data to the view
        $this->load->view('admin/header',$data);
        $this->load->view('admin/teacher_profile', $teacher);  // Pass user data to the view
        $this->load->view('admin/footer');
    }
...
public function parent(){
    ...
    $data['circle'] = $this->User_model->get_circle();
    $data['division'] = $this->User_model->get_division();
    $data['all_teacher'] = $this->User_model->get_all_users_by_role("teacher");
    $this->load->view('admin/header', $data);
...
public function parent_edit_profile($user_id){
    ...
    $data['all_teacher'] = $this->User_model->get_all_users_by_role("teacher");
    $this->load->view('admin/header', $data);
    $this->load->view('admin/parent-edit', $data);
    $this->load->view('admin/footer');
}

public function parent_list(){
    
    $parent['parent'] = $this->User_model->get_active_users("parent");
    $this->load->view('admin/header', $data);
    $this->load->view('admin/parent_list', $parent);
    $this->load->view('admin/footer');
}
...
public function parent_profile($user_id) {
    ...
    // Pass user data to the view
    $this->load->view('admin/header',$data);
    $this->load->view('admin/parent_profile', $parent);  // Pass user data to the view
    $this->load->view('admin/footer');
}
...
public function child(){
    ...
    $data['all_parent'] = $this->User_model->get_all_users_by_role("parent");
    $this->load->view('admin/header', $data);
    $this->load->view('admin/child');
    $this->load->view('admin/footer');
}
...
public function child_edit_profile($child_id){
    ...
    $data['all_parent'] = $this->User_model->get_all_users_by_role("parent");
    $this->load->view('admin/header', $data);
    $this->load->view('admin/child-edit', $data);
    $this->load->view('admin/footer');
}

public function child_list(){
    
    $child['child'] = $this->User_model->get_active_child();
    $this->load->view('admin/header', $data);
    $this->load->view('admin/child_list', $child);
    $this->load->view('admin/footer');
}
...
public function child_profile($user_id) {
    ...
    // Pass user data to the view
    $this->load->view('admin/header',$data);
    $this->load->view('admin/child_profile', $child);  // Pass user data to the view
    $this->load->view('admin/footer');
}
...
public function section_list(){
    ...
    $this->load->view('admin/header', $data);
    $this->load->view('admin/section_list', $section);
    $this->load->view('admin/footer');
}
...
public function section_details($section_id) {
    ...
    // Pass user data to the view
    $this->load->view('admin/header',$data);
    $this->load->view('admin/section_details', $section);  // Pass user data to the view
    $this->load->view('admin/footer');
}
