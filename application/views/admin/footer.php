        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('admin/dfo_list') ?>";
                } else {
...
<?php if($teacher_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/save_teacher'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('admin/teacher_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
...
<?php if($parent_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/save_parent'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('admin/parent_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
...
<?php if($child_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/save_child'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('admin/child_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
...
<?php if($section_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/save_section'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('admin/section_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
...
<?php if($dfo_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_dfo').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($teacher_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_teacher').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($parent_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_parent').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($child_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_child').'/'.$child_data['child_id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($section_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_section').'/'.$section_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($user_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('admin/edit_your_profile'); ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
