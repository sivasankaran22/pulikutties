                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Teacher</h1>
                                        </div>
                                        <form class="user" id="registerForm"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <select class="form-control" id="gender" name="gender">
                                                    ...
                                                    <?php foreach ($gender as $key => $value): ?><?php $selected = ($key == $user_data["gender"]) ? "selected" : ""; ?>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <label>Select DFO</label>
                                                <select class="form-control" id="map_id" name="map_id" required>
                                                    <option value="">-- Select DFO --</option>
                                                    <?php foreach ($all_dfo as $value): ?>
                                                        <?php $selected = ($value['id'] == $user_data["parent_id"]) ? "selected" : ""; ?>
                                                        <option value="<?php echo $value["id"] ?>" <?php echo $selected; ?>><?php echo $value["first_name"]." ".$value["last_name"]." (".$value["circle_name"]." - ".$value["division_name"].")"; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
