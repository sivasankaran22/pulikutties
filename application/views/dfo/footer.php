...
<?php if($dfo_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('dfo/save_dfo'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
...
<?php if($teacher_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('dfo/save_teacher'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
...
<?php if($parent_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('dfo/save_parent'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
...
<?php if($child_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('dfo/save_child'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
...
<?php if($section_js_script){ ?>
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url('dfo/save_section'); ?>',
            type: 'POST',
            data: formData,
            dataType: 'json',
            processData: false, // Don't process the data
...
<?php if($dfo_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_dfo').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($teacher_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_teacher').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($parent_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_parent').'/'.$user_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($child_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_child').'/'.$child_data['child_id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($section_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_section').'/'.$section_data['id']; ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
...
<?php if($user_js_script_edit){ ?>
    ...
    $(document).ready(function () {
        ...
        $('#registerForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url('dfo/edit_your_profile'); ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                processData: false, // Don't process the data
