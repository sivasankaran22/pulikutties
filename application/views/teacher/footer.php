        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('teacher/dfo_list') ?>";
                } else {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('teacher/teacher_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('teacher/parent_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('teacher/child_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    window.location.href = "<?php echo site_url('teacher/section_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
    ...
    $('#registerForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status === 'success') {
                    alert('Section added successfully!');
                    window.location.href = "<?php echo site_url('teacher/attendees_list') ?>";
                } else {
                    alert('Error: ' + response.message);
                }
            },
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        window.location.href = "<?php echo site_url('teacher/user-edit-profile') ?>";
                    } else {
                        alert('Error: ' + response.message);
                    }
                },
